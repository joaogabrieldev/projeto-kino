...
export const styles = sortCx({
  ...
  colors: {
    primary: {
      root: [
        // Dark Mode Settings
        "dark:bg-brand-solid dark:text-white dark:shadow-xs-skeumorphic dark:ring-1 dark:ring-transparent dark:ring-inset dark:hover:bg-brand-solid_hover dark:data-loading:bg-brand-solid_hover",
        // Inner border gradient
        "dark:before:absolute dark:before:inset-px dark:before:border dark:before:border-white/12 dark:before:mask-b-from-0%",
        // Disabled styles
